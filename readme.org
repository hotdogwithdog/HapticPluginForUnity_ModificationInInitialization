...
*THIS IS A MODIFICATION DO BY Iván García García, it's just in the initialization of the plugin wrapper for unity the rest it's the same of the original just do it in other repository for comfort   
